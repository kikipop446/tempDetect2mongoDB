            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):#det代表該圖片有幾個物件框
                    if save_txt:  # Write to file
                        ...
                        equip_dictionary['image'] = imagePath
...
if __name__ == '__main__':
    ...
    # client = MongoClient("mongodb://140.118.172.140:27017/")
    # db = client.TSMC_test
        ...
        if start_num["number"] == 1:
            ...
            for img_name in img_names:
                ...
                try:
                    ...
                    #end1 = time.time()
                    yolo_detect_path = fir.save_images(today+"-"+"{:03d}".format(day_counter))#原圖轉成可視影像和熱影像(無其他字擋住
                    #end2 = time.time()
